...
export const Teamwork = () => {
    return (
      <Stack>
        <Typography variant="h6">Teamwork and Service</Typography>
        <Stack spacing={2}>
              <Typography>
              Recommendation from a past co-worker
              </Typography>
              <Typography>
              &rdquo;I had the privilege of working alongside Edric at Abyss Solutions and was impressed by his curiosity, technical expertise, and his exceptional ability to cultivate positive team dynamics.
...
It has been a pleasure working with Edric.&rdquo;
              </Typography>
